...
HD_PWD='/home/ehs/Desktop/test/Ethernet/modify_src/proj_ethernet/proj_ethernet.runs/design_1_rmii_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rmii_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rmii_0_0.tcl
