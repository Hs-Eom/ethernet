...
#
# Script generated by Vivado on Sun Mar 30 15:16:23 KST 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : data_fifo.sh
...
#
# Usage        : data_fifo.sh
#                data_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                data_fifo.sh [-reset_run]
#                data_fifo.sh [-reset_log]
#                data_fifo.sh [-help]
#
...
# script info
echo -e "data_fifo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./data_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_fifo xil_defaultlib.data_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim data_fifo -key {Behavioral:sim_1:Functional:data_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb data_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./data_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: data_fifo.sh [-help]\n\
Usage: data_fifo.sh [-step]\n\
Usage: data_fifo.sh [-lib_map_path]\n\
Usage: data_fifo.sh [-reset_run]\n\
Usage: data_fifo.sh [-reset_log]\n\
Usage: data_fifo.sh [-keep_index]\n\
Usage: data_fifo.sh [-noclean_files]\n\n\
