...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AXI_OUT_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "INCLUDE_CRLF" -parent ${Page_0}
  ipgui::add_param $IPINST -name "POSTFIX_CHARS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "POSTFIX_STRING" -parent ${Page_0}
  ipgui::add_param $IPINST -name "PREFIX_CHARS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "PREFIX_STRING" -parent ${Page_0}
