...
#
# Script generated by Vivado on Sun Mar 30 15:13:17 KST 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axis_data_fifo_tuser.sh
...
#
# Usage        : axis_data_fifo_tuser.sh
#                axis_data_fifo_tuser.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_data_fifo_tuser.sh [-reset_run]
#                axis_data_fifo_tuser.sh [-reset_log]
#                axis_data_fifo_tuser.sh [-help]
#
...
#                script (type 'axis_data_fifo_tuser.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axis_infrastructure_v1_1_1 -libname axis_data_fifo_v2_0_11 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_11 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axis_data_fifo_tuser.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_data_fifo_tuser.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_11 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_data_fifo_tuser xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_data_fifo_tuser -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_data_fifo_tuser_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_data_fifo_tuser.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_data_fifo_tuser.sh [-help]\n\
Usage: axis_data_fifo_tuser.sh [-step]\n\
Usage: axis_data_fifo_tuser.sh [-lib_map_path]\n\
Usage: axis_data_fifo_tuser.sh [-reset_run]\n\
Usage: axis_data_fifo_tuser.sh [-reset_log]\n\
Usage: axis_data_fifo_tuser.sh [-keep_index]\n\
Usage: axis_data_fifo_tuser.sh [-noclean_files]\n\n\
