...
design_libs=(xpm axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_11 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_data_fifo_v2_0_11 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_data_fifo_tuser xil_defaultlib.glbl -o axis_data_fifo_tuser_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_data_fifo_tuser_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axis_data_fifo_tuser_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_data_fifo_tuser_simv.daidir vcs_lib c.obj)
